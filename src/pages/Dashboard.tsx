...
import { Trophy, Target, Clock, Star, Book, MessageCircle, Code, Award, LogOut } from "lucide-react";
...
export default function Dashboard() {
  ...
  const progress = (profile.lessons_completed / totalLessons) * 100;
  const weeklyGoal = 5;
      ...
      <div className="p-6 space-y-6 -mt-8 relative z-10">
        ...
        <AnimatedCard className="bg-card/95 backdrop-blur-sm border-2">
          <div className="flex items-center space-x-4">
            <div className="text-4xl animate-bounce-slow">{profile.avatar}</div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <AnimatedCard variant="primary">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-primary-foreground">{profile.lessons_completed}</p>
          ...
          <AnimatedCard variant="secondary">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-secondary-foreground">{profile.exercises_completed}</p>
          ...
          <AnimatedCard variant="accent">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-accent-foreground">{profile.current_streak}</p>
        ...
        <AnimatedCard>
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm text-muted-foreground">{profile.lessons_completed}/{totalLessons}</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Completar {weeklyGoal} lições</span>
                <span className="text-foreground">{profile.current_streak}/{weeklyGoal}</span>
              </div>
              <Progress value={(profile.current_streak / weeklyGoal) * 100} className="h-2" />
            </div>
          </div>
        </AnimatedCard>
      </div>
